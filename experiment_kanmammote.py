...
models = ['JODIE', 'DyRep', 'TGN', 'TCL', 'GraphMixer','CAWN','DyGFormer', 'DyGMamba'] # 
models = ['DyGFormer']
datasets = ['wikipedia',  'mooc', 'lastfm', 'enron', 'SocialEvo', 'uci','reddit'] #,

# File to track completed runs (simple text file)
log_file = 'completed_experiments_KANMAMMOTE.txt'
