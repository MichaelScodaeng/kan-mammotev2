...
COLORS = {
    ...
    'kan_mammote_dual_kmote': '#ff7f0e',        # Bright Orange (high visibility)
    'kan_mammote_lite_attention': '#9467bd',    # Medium Purple
    'kan_mammote_lite_concat': '#17becf',       # Cyan / Aqua
    'kan_mammote_lite_weighted': '#e377c2',     # Soft Pink
    'lete': '#7f7f7f',                          # Gray
    'mercer': '#bcbd22',                        # Olive
}
...
DISPLAY_NAMES = {
    ...
    'kan_mammote_dual_kmote': 'LSTM+kan_mammote (Full)',
    'kan_mammote_lite_attention': 'LSTM+kan_mammote_lite (attention)',
    'kan_mammote_lite_concat': 'LSTM+kan_mammote_lite (concat+MLP)',
    'kan_mammote_lite_weighted': 'LSTM+kan_mammote_lite (weighted)',
    'lete': 'LSTM+lete',
    'mercer': 'LSTM+mercer',
}
