#!/bin/bash
#PBS -N hptune_wikipedia_TGAT_c001
#PBS -l select=1:ncpus=4:mem=16gb:ngpus=1:gpu_type=RTX6000
#PBS -l walltime=02:00:00
#PBS -j oe
#PBS -o hptune_test_output/logs/hptune_wikipedia_TGAT_c001.log
...
# Print job info
echo "========================================="
echo "Job: hptune_wikipedia_TGAT_c001"
