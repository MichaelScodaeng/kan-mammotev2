#!/bin/bash
#PBS -N hptune_Contacts_TCL_c002
#PBS -l select=1:ncpus=4:mem=16gb:ngpus=1:gpu_type=RTX6000
#PBS -l walltime=02:00:00
#PBS -j oe
#PBS -o hptune_jobs/logs/hptune_Contacts_TCL_c002.log
...
# Print job info
echo "========================================="
echo "Job: hptune_Contacts_TCL_c002"
