#!/bin/bash
#PBS -N hptune_lastfm_JODIE_c002
#PBS -l select=1:ncpus=4:mem=16gb:ngpus=1:gpu_type=RTX6000
#PBS -l walltime=02:00:00
#PBS -j oe
#PBS -o hptune_jobs/logs/hptune_lastfm_JODIE_c002.log
...
# Print job info
echo "========================================="
echo "Job: hptune_lastfm_JODIE_c002"
echo "Dataset: lastfm"
echo "Model: JODIE"
echo "Config Index: 2"
echo "Config: {
