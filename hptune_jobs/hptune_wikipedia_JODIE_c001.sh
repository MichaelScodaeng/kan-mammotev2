...
#PBS -j oe
#PBS -o hptune_jobs/logs/hptune_wikipedia_JODIE_c001.log
...
# Run experiment
python experiments/train_link_prediction.py --dataset_name wikipedia --model_name JODIE --time_encoder_type kan_mammote_dual_kmote --expert_dim 128 --mamba_d_state 128 --mamba_expand 4 --dropout 0.1 --mamba_headdim 64 --mamba_d_conv 4 --data_ratio 1.0 --train_only_ratio 1.0 --num_epochs 10 --patience 3 --num_runs 1 --seed 0 --test_interval_epochs 1 --checkpoint_strategy minimal --disable_progress_bar --save_model_name_suffix hptune_c001_ed128_ds128_ex4 --ablation_dir ./hptune_results/wikipedia/JODIE
