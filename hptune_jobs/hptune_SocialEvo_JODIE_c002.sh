#!/bin/bash
#PBS -N hptune_SocialEvo_JODIE_c002
#PBS -l select=1:ncpus=4:mem=16gb:ngpus=1:gpu_type=RTX6000
#PBS -l walltime=02:00:00
#PBS -j oe
#PBS -o hptune_jobs/logs/hptune_SocialEvo_JODIE_c002.log
...
# Print job info
echo "========================================="
echo "Job: hptune_SocialEvo_JODIE_c002"
